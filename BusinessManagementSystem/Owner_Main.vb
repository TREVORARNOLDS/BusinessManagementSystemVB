...
Public Class Owner_Main
    ...
    Public Shared LastBackUp As String
    ...
    Private Sub BackUpbtn_Click(sender As Object, e As EventArgs) Handles BackUpbtn.Click
        ...
        'System.InvalidCastException: 'Conversion from string "24/03/2015 14:21:58" to type 'Date' is not valid.'
        Path = Directory.GetCurrentDirectory() & "\Last_Backup_Details.txt"
    ...
    Private Sub SalesAnalysisbtn_Click(sender As Object, e As EventArgs)
        Sales_Analysis.Show()
    End Sub
End Class